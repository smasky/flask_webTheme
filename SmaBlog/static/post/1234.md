...
<center style='font-size:15px'>$W(\alpha_1,\alpha_2)=-\frac{1}{2}(\alpha_1y_1x_1)^2-(\alpha_1\alpha_2x_1x_2y_1y_2)-\frac{1}{2}(\alpha_2y_2x_2)^2-(\alpha_1y_1x_1+\alpha_2y_2x_2)\sum\limits_{j=3}^{n}\alpha_jy_jx_y+\alpha_1+\alpha_2$</center>
...
<center style='font-size:30px'>$\alpha_1\ge0$</center>

<center style='font-size:30px'>$\alpha_2\ge0$</center>
...
<center style='font-size:30px'>$\alpha_2^{new}\ge max(0,-\zeta)$</center>
...
<center style='font-size:30px'>$0 \ge \alpha_2^{new}\ge \zeta$</center>
...
<center style='font-size:30px'>$\alpha_i> 0、y_i(w^Tx+b)=1$</center>

<center style='font-size:30px'>$\alpha_i=0、y_i(w^Tx+b)>1$</center>

这也是我们选择$\alpha_i$的一个条件，即选择那些不满足以上两种情况的$\alpha_i$，即

<center style='font-size:30px'>$\alpha_i> 0、y_i(w^Tx+b)\ne 1$</center>

<center style='font-size:30px'>$\alpha_i=0、y_i(w^Tx+b)\le 1$</center>
